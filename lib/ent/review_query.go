...
func (_q *ReviewQuery) QueryOwner() *UserQuery {
...
func (_q *ReviewQuery) WithOwner(opts ...func(*UserQuery)) *ReviewQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ReviewQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Review, init func(*Review), assign func(*Review, *User)) error {
